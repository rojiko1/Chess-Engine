class Evaluator():
    ...
    def __init__(self):
        ...
        self.WHITE_PAWN_MAPPING = [
            [0.37, 0.35, 0.34, 0.41, 0.41, 0.34, 0.35, 0.37],
            [0.34, 0.29, 0.33, 0.38, 0.38, 0.33, 0.29, 0.34],
            [0.23, 0.29, 0.31, 0.36, 0.36, 0.31, 0.29, 0.23],
            [0.28, 0.32, 0.34, 0.36, 0.36, 0.34, 0.32, 0.28],
            [0.20, 0.28, 0.31, 0.33, 0.33, 0.31, 0.28, 0.20],
            [0.17, 0.23, 0.30, 0.25, 0.25, 0.30, 0.23, 0.17],
